...
- (void)setRoadArray:(NSArray *)roadArray
{
    _roadArray = roadArray;
    _roadPMV.tableArray = roadArray;
}

- (void)setStreetArray:(NSArray *)streetArray
{
    _streetArray = streetArray;
    _streetPMV.tableArray = streetArray;
}
...
#warning mark - 临时显示
    ...
    */
    ...
    // 所在路
    self.roadPMV = [[PulldownMenusView alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(label7.frame), CGRectGetWidth(label7.frame), 30)];
    _roadPMV.textField.text = @"请选择路";
    _roadPMV.textField.textColor = [UIColor lightGrayColor];
    _roadPMV.textField.font = [UIFont systemFontOfSize:14.0f];
    [self addSubview:_roadPMV];
    
    // 所在街道
    self.streetPMV = [[PulldownMenusView alloc] initWithFrame:CGRectMake(CGRectGetMinX(label8.frame), CGRectGetMaxY(label8.frame), CGRectGetWidth(label7.frame), 30)];
    _streetPMV.textField.text = @"请选择街";
    _streetPMV.textField.textColor = [UIColor lightGrayColor];
    _streetPMV.textField.font = [UIFont systemFontOfSize:14.0f];
    [self addSubview:_streetPMV];
    ...
    [_reduceButton setTitle:@"取消" forState:UIControlStateNormal];
...
{
    [_roadPMV clickOnTheOther];
    [_streetPMV clickOnTheOther];
    NSLog(@"点击了屏幕");
}
