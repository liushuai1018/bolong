...
- (NSString *)accessModel
{
    ...
    if ([deviceString isEqualToString:@"iPhone4,1"])    return @"3.5_inch"; // 4s
    if ([deviceString isEqualToString:@"iPhone5,1"])    return @"4_inch"; // 5s
    ...
    if ([deviceString isEqualToString:@"iPhone7,2"])    return @"4.7_inch"; // 6
    if ([deviceString isEqualToString:@"iPhone8,1"])    return @"4.7_inch";
    if ([deviceString isEqualToString:@"iPhone7,1"])    return @"5.5_inch"; // 6p
